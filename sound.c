...
void wavdata(WAVheader h, FILE *fp){
	//in this function we will read sound samplie from the opened file
	...
	int peaks=0, flag=0;	//1st value is to count, 2nd value to show that you are in the peak
	...
	//diaplay sample rate, duration, no. of peaks on top of the screen
	gotoXY(1,1); printf("Sample Rate: %d\n", h.sampleRate);
	gotoXY(1,50); printf("Duration: %f s\n", (float)h.subchunk2Size/h.byteRate);
	gotoXY(1,100); printf("Peaks: %d\n", peaks);
}
//end of file
